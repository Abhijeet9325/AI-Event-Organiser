                        ...
                        <div className="flex flex-col md:flex-row items-center gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <DialogDescription className="text-zinc-400 text-sm md:text-base mt-1 font-medium">
                                    {trigger === "header" && "Take your events to the next level with Pro access."}
                                    {trigger === "limit" && "You've reached your free limit. Scale up with Pro!"}
                                    {trigger === "color" && "Personalize your brand with custom Pro themes."}
                                </DialogDescription>
                            </div>
                        </div>
                    </DialogHeader>
