...
export default function Home() {
  ...
  <div className="flex gap-4 mt-8 flex-wrap justify-center">
    <button className="bg-green-500 hover:bg-green-400 text-black px-6 py-2 rounded-lg font-medium transition">
      Start your event
    </button>

    <button className="bg-white/10 hover:bg-white/20 border border-white/10 px-6 py-2 rounded-lg transition">
      Documentation
    </button>
  </div>
